...
Before your project gets to [Coveralls](http://coveralls.io), it must already be using a __code coverage library__ to generate coverage results. In this project, we're using the Ruby-based [Simplecov](https://github.com/colszowka/simplecov):
